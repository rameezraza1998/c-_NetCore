...
public delegate int NumberChanger(int n1);
...
public class ChangeNumber
{
    ...
    public int AddNum(int n1)
    {
        return n1 + num;
    }

    public int MultiNum(int n1)
    {
        return n1 * num;
    }
...
class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        NumberChanger nc1 = new NumberChanger(changeNumber.AddNum);
        int Addresult = nc1(10);
        Console.WriteLine(Addresult);

        Console.WriteLine();

        NumberChanger nc2 = new NumberChanger(changeNumber.MultiNum);
        int Mulresult = nc2(100);
